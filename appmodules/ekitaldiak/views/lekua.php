...
class LekuaView {
    ...
    public function agregar() {
        $str = file_get_contents(
            CUSTOM_STATIC_DIR . "html/ekitaldiak/lekua_agregar.html");
        print Template('Agregar Lekua')->show($str);
    }

    public function editar($obj=array()) {
        $str = file_get_contents(
            CUSTOM_STATIC_DIR . "html/ekitaldiak/lekua_editar.html");
    ...
    public function listar($coleccion=array()) {
        $str = file_get_contents(
            CUSTOM_STATIC_DIR . "html/ekitaldiak/lekua_listar.html");
